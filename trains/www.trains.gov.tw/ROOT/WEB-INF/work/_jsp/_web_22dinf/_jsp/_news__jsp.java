...
public class _news__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws Throwable
  {
    ...
    out.print((news.getDate1()));
    out.write(_jsp_string13, 0, _jsp_string13.length);
    out.print((news.getSubject1()));
    out.write(_jsp_string14, 0, _jsp_string14.length);
    out.print((news.getContent1()));
    out.write(_jsp_string15, 0, _jsp_string15.length);
    _jsp_UrlTag_0 = _jsp_state.get_jsp_UrlTag_0(pageContext, _jsp_parent_tag);
    _jsp_UrlTag_0.setValue("/image/news0.jpg");
    _jsp_UrlTag_0.doStartTag();
    _jsp_UrlTag_0.doEndTag();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("WEB-INF/jsp/news.jsp"), 9102448127166529977L, false);
    _caucho_depends.add(depend);
  ...
  public void caucho_init(ServletConfig config)
  {
    try {
      ...
      _caucho_expr_0 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${id}");
    } catch (Exception e) {
  ...
  static {
    ...
    _jsp_string11 = "\r\n\r\n					<div class=\"news\">\r\n						<div class=\"newstitle\">\u7b2c".toCharArray();
