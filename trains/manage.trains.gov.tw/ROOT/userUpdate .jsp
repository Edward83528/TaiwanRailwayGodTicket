...
<script type="text/javascript">
	function save() {
		...
		document.mform.action = "userUpdateSave.jsp";
...
<body>
	...
	<form action='userAddSave' method='post' name="mform">
		...
		<fieldset>
			...
			<div id="addback">
				<div class="title">
					<label for="backtitle">姓名:</label><input type="text" id="backtitle"
						name='name' value="<%=list.getUserName()%>"
						onFocus="javascript: if (this.value=='請輸入姓名') this.value='';"
						onBlur="javascript: if(this.value=='') this.value='請輸入姓名';">
				</div>
				<div class="title">
					<label for="backtitle">帳號:</label><input type="text" id="backtitle"
						name='user' value="<%=list.getUserKey()%>"
						onFocus="javascript: if (this.value=='請輸入帳號') this.value='';"
						onBlur="javascript: if(this.value=='') this.value='請輸入帳號';">
				</div>
				<div class="title">
					<label for="backtitle">密碼:</label><input type="text" id="backtitle"
						name='password' value="<%=list.getPassword1()%>"
